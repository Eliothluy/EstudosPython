...
vogaisa = texto_minusculo.count('a')
vogaise = texto_minusculo.count('e')
vogaisi = texto_minusculo.count('i')
vogaiso = texto_minusculo.count('o')
vogaisu = texto_minusculo.count('u')
vogaisTotal = vogaisa + vogaise + vogaisi + vogaiso + vogaisu
print(f'O texto tem {vogaisa} letras a')
print(f'O texto tem {vogaise} letras e')
print(f'O texto tem {vogaisi} letras i')
print(f'O texto tem {vogaiso} letras o')
print(f'O texto tem {vogaisu} letras u')
print(f'O texto tem o total de {vogaisTotal} vogais')
